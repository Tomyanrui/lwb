...
Component({
  ...
  methods: {
    ...
    bindchange(e) {
      ...
      const list2_name = this.data.list2[_idx][_showvalue];
      console.log('组件内',list2_name)
      this.setData({
        index: _idx,
        list2: this.data.list,
        picker_value: this.data.list2[_idx][_showvalue]
      })
      this.fun(list2_value,list2_name);
    },
    fun(list2_value,list2_name) {
      this.triggerEvent("action", {
        id: list2_value,name:list2_name
      });
    }
  }
})